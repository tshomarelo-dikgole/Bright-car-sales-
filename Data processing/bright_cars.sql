...
-- calculate total revenue generated by car sales
SELECT
  SUM(car_sales.sellingprice) AS total_revenue
FROM
  `bright-car-sales-494419`.`car_data`.`car_sales` AS car_sales;


-- calculate number of cars sold
SELECT
  COUNT(vin) AS number_of_cars_sold
FROM
  `car_data`.`car_sales` 
WHERE
...
-- calculate total profit generated by car sales
SELECT
...
-- calculate average margin from the car sales
SELECT
  AVG(sellingprice - mmr) AS average_margin
FROM
  `car_data`.`car_sales`;
